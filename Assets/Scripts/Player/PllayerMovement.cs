...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        inputActions.Movement.Vertical.performed += Vertical_performed;
        inputActions.Movement.Vertical.canceled += Vertical_canceled;

        inputActions.Movement.Jump.performed += Jump_performed;
        inputActions.Movement.Jump.canceled += Jump_canceled;
    ...
    private void Horizontal_canceled(InputAction.CallbackContext context)
    {
        moveInput.x = 0f;
    }
    ...
    {
        moveInput.x = obj.ReadValue<float>();
    }
    ...
    private void Run(float lerpAmount)
    {
        ...
        if ((IsJumping || IsWallJumping || _isJumpFalling) && Mathf.Abs(RB.linearVelocity.y) < Data.jumpHangTimeThreshold)
        {
            ...
            Debug.Log($"Target speed in jump accell {targetSpeed}");
        }
        #endregion
    ...
    private void Slide()
    {
        ...
        Debug.Log($"Slide Movement: {movement}");
